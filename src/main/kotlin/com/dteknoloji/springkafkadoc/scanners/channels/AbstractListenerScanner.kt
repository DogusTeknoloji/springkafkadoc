...
abstract class AbstractListenerScanner<T : Annotation>(
    ...
    private fun getAnnotatedMethods(type: Class<*>): Set<Method> {
        val annotationClass = getListenerAnnotationClass()
    ...
    private fun mapMethodToChannel(method: Method): Map.Entry<String, ChannelItem> {
        val listenerAnnotationClass = getListenerAnnotationClass()
    ...
    protected abstract fun getListenerAnnotationClass(): Class<T>
